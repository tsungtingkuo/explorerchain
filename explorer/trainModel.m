function obj = trainModel(XTR, YTR, lik_method, prior_variance, previous_obj)

% Tim: change label 0 to -1 for EXPLORER training;
YTR(YTR == 0) = -1;
...
% Tim: continue from previous model
if ~isempty(previous_obj)
    obj.mp = previous_obj.mw;
    obj.vp = previous_obj.vw;
end
